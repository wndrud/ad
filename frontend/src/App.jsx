...
const translations = {
  ...
  KO: {
    ...
    faqA4: "제품 이미지 또는 영상, 로고, 브랜드 소개, 참고 광고 레퍼런스 자료가 있으면 제작이 원활합니다.",
...
function App() {
  ...
  const nextServiceSlide = () => {
    setActiveServiceSlide((prev) => Math.min(prev + 1, 4));
  };

  const prevServiceSlide = () => {
    setActiveServiceSlide((prev) => Math.max(prev - 1, 0));
  };
  ...
  <div className='careers-page' style={{ paddingTop: '100px', paddingBottom: '60px' }}>
          ...
          <>
            ...
            <section id="work" className="about-sec container">
              ...
              {/* Desktop version (Original PC Design Restored) */}

              <div className="desktop-only section-grid" style={{ gridTemplateColumns: '0.8fr 1.2fr', gap: '4rem' }}>
                    ...
                    <div style={{
                      ...
                      <img 
                        ...
                        style={{
                          ...
                          transform: 'translate(-50%, calc(-50% + 5rem))', // Shifts only the logo image down by 5rem
              ...
              <div className="mobile-only about-grid">

                <div className="about-header-col">

                  <div className="about-header-text animate-on-scroll" style={{ position: 'relative', zIndex: 1 }}>

                    <div className="hero-tag about-tag-top">{translations[lang].aboutTag}</div>

                    

                    <div className="about-emblem-wrapper">
                      ...
                      <img 
                        ...
                        className="about-emblem-watermark"
                ...
                <div className="about-content-col">
                  ...
                  <div className="stats-grid animate-on-scroll" style={{ '--delay': '0.4s' }}>
